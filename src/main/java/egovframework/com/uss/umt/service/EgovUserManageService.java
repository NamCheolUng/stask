...
public interface EgovUserManageService  {
	...
	public void updateAtchFileId(UserManageVO userManageVO) throws Exception;
	...
	public String insertLeavingUserHistory(UserManageVO userManageVO) throws Exception;

	public UserManageVO selectEmpNo(UserManageVO userManageVO) throws Exception;
