package stask.com.user.service.impl;
...
*/
  ...
  /*  *//**
    ...
    public int selectGetEmplNo(UserManageVO userManageVO){
        return (int) select("userManageDAO.selectGetEmplNo", userManageVO);
    }*/
  ...
  /*  *//**
    ...
    public UserManageVO selectUser(String uniqId){
        return (UserManageVO) select("userManageDAO.selectUser_S", uniqId);
    }
*/
    /**
    ...
    public List<?> selectUserList(UserDefaultVO userSearchVO){
        return list("staskUserManageDAO.selectUserList", userSearchVO);
    }

    public int selectUserListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)select("staskUserManageDAO.selectUserListTotCnt_S", userSearchVO);
    }

	public void insertUser(UserManageVO userManageVO) {
		// TODO Auto-generated method stub
		insert("staskUserManageDAO.insertUser",userManageVO);
	}

	public UserManageVO selectUser(UserManageVO userManageVO) {
		// TODO Auto-generated method stub
		return (UserManageVO) select("staskUserManageDAO.selectUser",userManageVO);
	}

	public void updateUser(UserManageVO userManageVO) {
		// TODO Auto-generated method stub
		update("staskUserManageDAO.updateUser",userManageVO);
	}

	public void deleteUser(UserManageVO userManageVO) {
		// TODO Auto-generated method stub
		delete("staskUserManageDAO.deleteUser",userManageVO);
	}
  ...
  /*  public void updateUser(UserManageVO userManageVO){
    ...
    후불정산 이메일을 업데이트한다
    public void updateFoodEmail(UserManageVO userManageVO){
        update("userManageDAO.updateFoodEmail",userManageVO);
    }
    
    public void updateParkingEmail(UserManageVO userManageVO){
        update("userManageDAO.updateParkingEmail",userManageVO);
    }
    
    
    public void updateAtchFileId(UserManageVO userManageVO){
        update("userManageDAO.updateAtchFileId",userManageVO);
    }
    ...
    *//**
    ...
    public UserManageVO selectEmpNo(UserManageVO userManageVO){
    	return (UserManageVO) select("userManageDAO.selectEmpNo", userManageVO);
    }

    
    public String insertLeavingUserHistory(UserManageVO userManageVO){
    	return (String)insert("userManageDAO.insertLeavingUserHistory", userManageVO);
    }
    ...
    *//**
    ...
    public UserManageVO selectPassword(UserManageVO userManageVO){
    	return (UserManageVO) select("userManageDAO.selectPassword_S", userManageVO);
    }
    
    사용자ID 중복확인
    public int searchId(String checkId){
    	return (Integer)select("userManageDAO.searchId_S", checkId);
    }
    
    public void updateUserFileId(UserManageVO userManageVO){
        update("userManageDAO.updateUserFileId",userManageVO);
    }
   */
}