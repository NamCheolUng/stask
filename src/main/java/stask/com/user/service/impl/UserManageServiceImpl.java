 ...
 * </pre>
 */
@Service("userManageService2")
public class UserManageServiceImpl extends EgovAbstractServiceImpl implements UserManageService2 {

	/** userManageDAO */
	@Resource(name="userManageDAO2")
...
/*
	*//**
	...
	public int selectGetEmplNo(UserManageVO userManageVO) throws Exception {
        return (int) userManageDAO.selectGetEmplNo(userManageVO);
    }
	...
	*//**
	...
	public void updateUser(UserManageVO userManageVO) throws Exception {
		...
		userManageDAO.updateUser(userManageVO);
		userManageDAO.updateFoodEmail(userManageVO);
		userManageDAO.updateParkingEmail(userManageVO);
	}
	...
	*//**
	...
	public void updateAtchFileId(UserManageVO userManageVO) {
		userManageDAO.updateAtchFileId(userManageVO);
	}
	
	public UserManageVO selectEmpNo(UserManageVO userManageVO){
		return userManageDAO.selectEmpNo(userManageVO);
    }
	
	public String insertLeavingUserHistory(UserManageVO userManageVO) {
		return userManageDAO.insertLeavingUserHistory(userManageVO);
	}
	...
	*//**
	...
	사용자ID 중복확인
	@Override
	public int searchId(String checkId) throws Exception {
		
		return userManageDAO.searchId(checkId);
	}

	@Override
	public void updateUserFileId(UserManageVO userManageVO) throws Exception {
		userManageDAO.updateUserFileId(userManageVO);
	}
	...
	@Override
	public int selectUserList(String checkId) throws Exception {
		// TODO Auto-generated method stub
		return 0;
	}*/
}