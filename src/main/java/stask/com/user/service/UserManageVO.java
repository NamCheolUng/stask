...
/*	*//** 이전비밀번호 - 비밀번호 변경시 사용*//*
	...
	*//**
	...
	//입사일
	private BigDecimal emplyrBngde;
	//퇴사일
	private BigDecimal emplyrEndde;
	//영문 이름
	private String emplyrNmEn;
	//한자 이름
	private String emplyrNmCn;
	//관리자 권한
	...
	*//**
	...
	public BigDecimal getEmplyrBngde() {
		return emplyrBngde;
	}
	public void setEmplyrBngde(BigDecimal emplyrBngde) {
		this.emplyrBngde = emplyrBngde;
	}
	public BigDecimal getEmplyrEndde() {
		return emplyrEndde;
	}
	public void setEmplyrEndde(BigDecimal emplyrEndde) {
	...
	public String getEmplyrNmCn() {
		return emplyrNmCn;
	}
	public void setEmplyrNmCn(String emplyrNmCn) {
		this.emplyrNmCn = emplyrNmCn;
	}
	public String getManageAt() {
		return manageAt;
	}
	public void setManageAt(String manageAt) {
	...
	public String getHmtlnum() {
		return hmtlnum;
	}
	public void setHmtlnum(String hmtlnum) {
		this.hmtlnum = hmtlnum;
	}
