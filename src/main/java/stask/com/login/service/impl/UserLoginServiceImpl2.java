package stask.com.login.service.impl;
...
public class UserLoginServiceImpl2 extends EgovAbstractServiceImpl implements UserLoginService2 {
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	// 3. 결과를 리턴한다.
    	if (loginVO != null && !loginVO.getuId().equals("")) {
    		return loginVO;
    	} else {
    		loginVO = new LoginVO();
    	}
