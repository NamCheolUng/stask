...
public class TaskController {
	...
	@RequestMapping(value = "/com/task/tList.do")
	public String taskList(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, ModelMap model,
		...
		List<?> taskList = taskService.taskList(userSearchVO);
		model.addAttribute("resultList", taskList);
		
		int totCnt = taskService.taskListTotCnt(userSearchVO);
...
*/		 //부서구분
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/task/tInsertView.do")
	public String taskInsertView(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, @ModelAttribute("taskVO") TaskVO taskVO, Model model,
			 					HttpServletRequest request)throws Exception {

		return "stask/com/task/tInsert";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/task/tInsert.do")
...
/*	//사원 번호 생성
	...
	/*사용자 상세조회*/
	@RequestMapping("/com/task/tSelect.do")
	public String taskSelectView(@ModelAttribute("taskVO") TaskVO taskVO, Model model, HttpServletRequest request ) throws Exception {
		...
		TaskVO tVO= taskService.taskSelectView(taskVO);
		
 		model.addAttribute("tVO",tVO);
		//model.addAttribute("depart_result", depart_result); //부서구분
		//model.addAttribute("postion_result", postion_result); //직위구분
		return "stask/com/task/tSelect";
	}
...
/*	@RequestMapping("/com/member/EgovUserSelectUpdtView.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/task/tUpdate.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/com/task/tDelete.do")
	public String taskDelete(@ModelAttribute("taskVO") TaskVO taskVO,Model model) throws Exception {

		taskService.taskDelete(taskVO);
		//Exception 없이 진행시 등록성공메시지
